							...
							<div class="footer_block">
								...
								<div class="block_content">
									<!--  <div class="fb-page" data-small-header="true"
										data-href="https://www.facebook.com/anhvu1812"
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="footer_address">
								<p>
									<span>CÔNG TY CỔ PHẦN SEAFOOD</span>
								</p>
								<p>
									<span>Địa chỉ: 468 Xã Đàn, Nam Đồng, Đống Đa, Hà Nội</span>
								</p>
								<p>
									<span>Số điện thoại: (04) 66 85 85 38</span>
								</p>
								<p>
									<span>Số di động: 0909 2763 23</span>
								</p>
								<p>
									<span>Email: admin@seafood.vn</span>
								</p>
							</div>
						</div>
