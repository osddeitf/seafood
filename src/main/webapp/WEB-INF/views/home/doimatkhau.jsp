		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="breadcrumb clearfix">
					<ul>
						<li itemtype="/taikhoan/dangnhap" itemscope=""
							class="home"><a title="Đến trang chủ" href="/taikhoan/dangnhap"
				...
				<div class="foget-password-content clearfix"">
					...
					<div class="alert alert-info fade in">
						...
						<i class="fa-fw fa fa-check"></i> Điền vào thông tin mật khẩu bạn
						muốn đổi.
					</div>
					...
					<div
						...
						<form class="form-horizontal" action="/taikhoan/doimatkhau"
							method="post">
