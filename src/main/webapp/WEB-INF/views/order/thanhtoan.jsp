					...
					<form:form class="payment-block clearfix" modelAttribute="donHang"
							...
							<div class="step-preview clearfix">
								...
								<div class="radio">
									<label>
										...
										name="optionsRadios" />
											<img src="/assets/user/100004/images/paypal_logo.jpg"
											alt="Paypal-Logo" width="50px" height="50px"> 
											 Paypal
									</label>
									<label style="margin-left:5px">
										<input type="radio" value="{{item.Id}}"
										name="optionsRadios" />
											<img src="/assets/user/100004/images/vnpay_logo.jpg"
											alt="VnPayl-Logo" width="50px" height="50px"> 
											 Vn Pay
									</label>
									<label style="margin-left:5px">
								<!-- 	<input type="radio" value="{{item.Id}}"
										name="optionsRadios" /> -->
											<img src="/assets/user/100004/images/momo_logo.png"
											alt="Momo-Logo" width="50px" height="50px"> 
											 Momo
									</label>   
						...
						<div class="col-md-4 col-sm-12 col-xs-12 payment-step step1">
							...
							<div class="step-preview">
								...
								<img id="vnpay" onclick="getIPAddress()"  src="/assets/user/100004/images/vnpay_logo.jpg"
									alt="VnPayl-Logo" width="50px" height="50px"> 
									 Vn Pay
								 </img>
							</div>
